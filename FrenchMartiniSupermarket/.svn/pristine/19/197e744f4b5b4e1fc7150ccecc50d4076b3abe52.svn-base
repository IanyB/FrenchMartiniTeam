            ...
            using (connection)
            {
                using (var msSQLServerContext = new SupermarketEntities())
                {
                    ...
                    foreach (var vendor in vendors)
                    {
                        ...
                        insertCommand.Parameters.AddWithValue("@incomes", vendor.VendorName);
                        insertCommand.Parameters.AddWithValue("@expenses", vendor.VendorName);
                        insertCommand.Parameters.AddWithValue("@taxes", vendor.VendorName);
                        insertCommand.Parameters.AddWithValue("@financialResult", vendor.VendorName);
