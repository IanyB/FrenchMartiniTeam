...
public class Program
{
    ...
    private static List<VendorData> QueryIt()
    {
        ...
        var dbExpenses = db.GetCollection<MongoVendorExpense>("collectionVendors");

        var prodReport = db.GetCollection<MongoProductReport>("ProductReports");
    ...
    public static void InsertDataMonogDB()
    {
        ...
        //Insert Vendor
        var expenses = db.GetCollection<MongoVendorExpense>("collectionVendors");
